      ...
      >
        ...
        <View className="px-6 pt-4">
          <View className="flex-row items-center gap-2">
            <Sparkles color={brand[500]} size={20} strokeWidth={2.2} />
          ...
          <View className="relative overflow-hidden rounded-4xl bg-brand-600 px-5 py-6">
            ...
            <View className="mt-4 flex-row items-center gap-4">
              <View className="h-14 w-14 items-center justify-center rounded-2xl bg-white/20">
                <FeaturedIcon color="#ffffff" size={28} strokeWidth={2} />
              </View>
              <Text className="flex-1 text-xl font-bold leading-snug text-white">
                {featured.title}
              </Text>
            </View>
            <Text className="mt-3 text-sm leading-relaxed text-brand-50">
              ...
              return (
                ...
                >
                  <View
                    ...
                    style={{ backgroundColor: tint(tip.accent) }}
                  >
                    <Icon color={tip.accent} size={26} strokeWidth={2} />
                  </View>
                  <View className="flex-1">
                    <Text className="text-base font-semibold text-foreground">
                      {tip.title}
                    </Text>
                    <Text className="mt-1 text-sm leading-snug text-muted">
                      {tip.description}
                    </Text>
                  </View>
                </View>
        ...
        <View className="px-6 pt-8">
          <View className="flex-row items-center gap-3 rounded-3xl bg-surface-muted px-4 py-3">
            <HeartPulse color={brand[600]} size={20} strokeWidth={2} />
            <Text className="flex-1 text-xs leading-relaxed text-muted">
              This content is for general wellness only and is not a substitute
